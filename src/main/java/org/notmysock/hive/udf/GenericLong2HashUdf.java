...
public class GenericLong2HashUdf extends GenericUDF {
  ...
  public Object evaluate(DeferredObject[] arguments) throws HiveException {
    ...
    /*
     * hashcode = HashCodeUtil.calculateLongHashCode(longValue0) >>> 16 
     *            ^ HashCodeUtil.calculateLongHashCode(longValue1);
     */
    final int h = HashCodeUtil.calculateLongHashCode(l0) >>> 16
                  ^ HashCodeUtil.calculateLongHashCode(l1);
    output.set(h);
    return output;
  }
